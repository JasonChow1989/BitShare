 ...
 *
 */
public class FirstWebViewsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		homeback.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(FirstWebViewsActivity.this, MainActivity.class);
				startActivity(intent);
				FirstWebViewsActivity.this.finish();
			}
		});
